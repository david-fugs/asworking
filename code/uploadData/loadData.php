...
<style>
    ...
    content: "Choose File"; /* Texto personalizado */
}
...
<body>
                    ...
                    <div class="card-body">
                        <form  action="uploadItems.php" enctype="multipart/form-data" method="POST">
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">Allow extensions .xlsx or .xls.</small>
                            </div>
    ...
    fileInput.addEventListener("change", function() {
        if (fileInput.files.length > 0) {
            fileInput.labels[0].textContent = fileInput.files[0].name; 
        } else {
            fileInput.labels[0].textContent = "Choose the Excel File";
        }
    });
});
