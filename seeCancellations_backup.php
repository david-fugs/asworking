        ...
        row.addEventListener("click", function () {
          ...
          fetch(`getSellToReturn.php?sell_order=${encodeURIComponent(sell_order)}`)
            ...
            .then((data) => {
              ...
              document.querySelectorAll('.edit-cancellation').forEach(button => {
                button.addEventListener('click', function() {
                  ...
                  // Obtener datos de cancelación específicos para este UPC
                  const cancellation = cancellations[upcItem] || null;
                  
                  // Crear y mostrar el formulario de cancelación
            ...
            .catch((err) => {
              ...
              // Ya no necesitamos crear el formulario aquí, se creará al hacer click en "Edit Cancellation"
            });
        });
      });
    }
